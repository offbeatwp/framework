...
{
    /** @var Form|FieldsContainerInterface|FieldInterface|FieldsCollectionInterface */
    private $activeItem;
    /** @var array */
    private $fieldKeys = [];
    /** @var string */
    ...
    /** @param FieldsContainerInterface|FieldInterface|FieldsCollectionInterface $item */
    ...
    public function addComponentForm($component, $fieldPrefix): void {
