...
class ServiceMultipleInstances extends AbstractService {
    public function register()
    {
        add_filter( 'gform_get_form_filter', array( $this, 'gformGetFormFilter' ), 10, 2 );
        add_filter( 'gform_confirmation', array( $this, 'gformGetFormFilter' ), 10, 2 );
    }

    public function gformGetFormFilter( $form_string, $form ) {
